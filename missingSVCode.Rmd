...
```{r}
gen_miss_df_lyrics <- generate_azlyrics_urls(missing_df_lyrics, "Artist.s.", "Title")
```

```{r}
replacement_vector3 <- gen_miss_df_lyrics$lyrics_url 

# Check if the number of NAs matches the length of the replacement vector
missing_df_lyrics$lyrics_url[is.na(missing_df_lyrics$lyrics_url)] <- replacement_vector3
